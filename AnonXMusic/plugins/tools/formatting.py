...
@app.on_callback_query(filters.regex("^formatting."))
async def get_formatting_info(c: app, q: CallbackQuery):
    cmd = q.data.split(".")[1]
    kb = ikb([[("𝘽𝘼𝘾𝙆", "back.formatting")]])
...
Use this to make app feel a bit more customised! (only works in filters/notes)
...
app supports a large number of formatting options to make your messages more expressive. Take a look by clicking the buttons below!""",
