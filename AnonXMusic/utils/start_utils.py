...
from AnonXMusic import HELP_COMMANDS, LOGGER, app as Gojo
from AnonXMusic.database.chats_db import Chats
from AnonXMusic.database.notes_db import Notes
...
from AnonXMusic.utils.msg_types import Types
    ...
    return ikb(
        [
            [
                (
                    "add me",
                    f"https://t.me/{app.username}?startgroup=new",
                    "url",
                ),
                (
                    "Support 👥",
...
async def get_help_msg(m: Message or CallbackQuery, help_option: str):
    """Helper function for getting help_msg and its keyboard."""
    help_msg = None
    help_kb = None
