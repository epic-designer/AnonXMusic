...
from config import LOGGER_ID as MESSAGE_DUMP
from AnonXMusic import app
from AnonXMusic.utils.http_helper import *
from AnonXMusic.utils.sticker_help import resize_file_to_sticker_size
...
async def youtube_downloader(c:app,m:Message,query:str,is_direct:bool,type_:str):
    if type_ == "a":
        # opts = song_opts
        video = False
        song = True
